          ...
          <div class="ui two column doubling grid">
            <div class="column">
              <div class="ui container">
                ...
                echo form_hidden('tenatnuserid',$dt->tenants_users_user_id);
                echo '<td>';
            ...
            <div class="column">
              <div class="ui secondary pointing menu">
                <a class="item active" href="<?php echo base_url().'buildingone'?>">Building 1</a>
                ...
                <a class="item" href="<?php echo base_url().'buildingfive'?>">Building 5</a>
              </div>
               <?php
